...
If I don't want the messages above to appear in my final document, I can add 'message=FALSE' to the top part of the chunk.
...
Please keep sharing any questions you have in Piazza. 

## Note about avatar.csv
Note: You can upload the replacement avatar data with the upload button in the files pane. The data has been posted on Quercus (with the data video) and on Piazza. (See question on Piazza: https://piazza.com/class/kduqugarxnh7ns?cid=20)
